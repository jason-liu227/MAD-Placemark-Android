...
fun addPlacemark() {
    ...
    val x = readlnOrNull()?.trim().orEmpty()
    print("Enter Y Coordinate: ")
    val y = readlnOrNull()?.trim().orEmpty()
}
...
fun listPlacemarks() {
    ...
    if (placemarks.isEmpty()) {
        ...
        placemarks.forEach { println("ID: ${it.id} | Title: ${it.title} | Description: ${it.description} | X-Coord: ${it.x} | Y-Coord: ${it.y}") }
    }
}
...
fun updatePlacemark() {
    ...
    if (id != null && store.findOne(id) != null) {
        ...
        val description = readlnOrNull()?.trim().orEmpty()
        print("Enter New X-Coord: ")
        val x = readlnOrNull()?.trim().orEmpty()
        print("Enter New Y-Coord: ")
        val y = readlnOrNull()?.trim().orEmpty()
...
fun searchPlacemark() {
    ...
    if (id != null) {
        ...
        if (placemark != null) {
            println("Found: ID: ${placemark.id} | Title: ${placemark.title} | Description: ${placemark.description} | X-Coord: ${placemark.x} | Y-Coord: ${placemark.y}")
        } else {
